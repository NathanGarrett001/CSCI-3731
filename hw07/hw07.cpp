...
int main()
{
	...
	v3.subVect(v1, v2, &x, &y, &z);
	std::cout << "Your subtracted vector coordinates are : x = " << x << ", y = " << y << ", z = " << z << std::endl;
	...
	std::cout << "The dot Product of your two pints is " << v3.multVects(v1, v2, &x, &y, &z) << ". " << std::endl;
